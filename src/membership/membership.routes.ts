...
membershipRouter.put("/:id", controller.sanitizeMembresiaInput, controller.update);
membershipRouter.patch("/:id", controller.sanitizeMembresiaInput, controller.update);
