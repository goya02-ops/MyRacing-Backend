...
circuitVersionRouter.post("/", controller.sanitizeCircuitVersionInput,controller.add);
circuitVersionRouter.put("/:id", controller.sanitizeCircuitVersionInput,controller.update);
circuitVersionRouter.patch("/:id", controller.sanitizeCircuitVersionInput, controller.update);
